...
(13, 'admin@yahoo.com', 55082746, 'Classic Comic', 'https://img.freepik.com/free-vector/vintage-colored-theatre-advertising-poster_1284-39338.jpg?w=2000', 250, 500, '2022-12-12', '16:30', 'Chittagong', 'Bkash');
...
--
ALTER TABLE `user_purchase_t`
  MODIFY `purchaseID` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
